    ...
    <div id="background-div" class="page-holder bg-cover">
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          ...
          <p id="content" class="lead mb-0 bg-dark p-1 rounded">Enjoy Upto 60% off on all our Categories.
            Choose through or wide range of products and enjoy your shopping</p>
        </header>
      </div>
    </div>
